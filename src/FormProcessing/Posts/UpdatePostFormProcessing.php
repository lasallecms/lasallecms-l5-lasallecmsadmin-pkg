...
namespace Lasallecms\Lasallecmsadmin\FormProcessing\Posts;
...
class UpdatePostFormProcessing extends BaseFormProcessing
{
     ...
     */
    public function __construct(PostRepository $repository, FeaturedImageProcessing $featuredImageProcessing) {
